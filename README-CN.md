...
compile 'com.deltadna.android:deltadna-smartads:1.4.2'

// 广告提供商
compile 'com.deltadna.android:deltadna-smartads-provider-adcolony:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-admob:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-amazon:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-applovin:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-chartboost:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-facebook:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-flurry:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-inmobi:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-ironsource:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-mobfox:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-mopub:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-thirdpresence:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-unity:1.4.2'
compile 'com.deltadna.android:deltadna-smartads-provider-vungle:1.4.2'
```

...
compile 'com.deltadna.android:deltadna-smartads:1.2.7-SNAPSHOT'

// 广告提供商
compile 'com.deltadna.android:deltadna-smartads-provider-adcolony:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-admob:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-amazon:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-chartboost:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-flurry:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-inmobi:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-mobfox:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-mopub:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-supersonic:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-unity:1.2.7-SNAPSHOT'
compile 'com.deltadna.android:deltadna-smartads-provider-vungle:1.2.7-SNAPSHOT'
```

...
public final class SupersonicInterstitialAdapter extends MediationAdapter {
    ...
    public SupersonicInterstitialAdapter(
            int eCPM,
            int demoteOnCode,
            int waterfallIndex,
            String appKey,
    ...
    private final class RequestTask extends UserIdRequestTask {
        ...
        protected void onPostExecute(String userId) {
            ...
            if (userId != null) {
                AGENT.setInterstitialListener(
                        new SupersonicInterstitialForwarder(
                                SupersonicInterstitialAdapter.this,
                                listener));
                AGENT.initInterstitial(activity, appKey, userId);
            }
        }
    }
}

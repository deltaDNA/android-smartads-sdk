...
final class RewardedEventForwarder implements RewardedAdRequestListener {
    
    private final EventForwarder delegate;
    
    private boolean complete;
    
    RewardedEventForwarder(EventForwarder delegate) {
    ...
    public void OnCollapsed(AdRequest request) {
        delegate.onCollapsed(request, complete);
    }
}
